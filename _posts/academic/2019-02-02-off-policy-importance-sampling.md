...
แต่ว่าถ้าเราไม่ได้ sample $$x$$ จาก $$f(x)$$ แต่เป็น $$g(x)$$ แทนล่ะ ? เราก็ยังหาค่าคาดหวังได้อยู่ดีแหละดังนี้
...
เราจะได้ว่า หากทุกครั้งที่เรา sample $$x \sim g(x)$$ แล้วแทนที่จะใช้ค่า $$f(x)$$ ตรง ๆ เลยเราเอาค่านั้นมาคูณด้วย $$\frac{p(x)}{g(x)}$$ (เรียกว่า **Importance sampling ratio**) ก่อน เราก็จะได้ค่าคาดหวังอันเดิมได้นั่นเอง แต่นั่นก็แปลว่าเราต้องรู้ด้วยว่า $$g(x)$$ ของเรานั้นมีค่าเท่าไหร่
...
ถ้าเรามองเฉพาะ reward แรก $$r_{t+1}​$$ เราจะเห็นว่า 
...
โดยเราจะหาความน่าจะเป็นที่จะ sample ได้ค่า $$r_{t+1}, r_{t+2}, \dots​$$ พร้อมกันทั้งหมดแทน ซึ่งก็สามารถทำได้ในลักษณะเดียวกัน กล่าวคือ

$$
r_{t+1}, r_{t+2} \sim \pi(a_t|s_t) p(r_{t+1}|s_t, a_t) p(s_{t+1}|s_t, a_t) \pi(a_{t+1}|s_{t+1}) p(r_{t+2}|s_{t+1}, a_{t+1})
$$

เราสามารถคาดต่อไปได้ว่าจนถึง $$r_{t+n}$$ จะมีหน้าตาอย่างไร

แต่ตอนนี้เราสามารถหาค่า Importance sampling ratio ระหว่าง $$\pi​$$ กับ $$b​$$ สำหรับ $$G_t​$$ ได้ดังต่อไปนี้
